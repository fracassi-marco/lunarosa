...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-beige-200 shadow-lg">
      ...
      {/* Mobile Menu Overlay */}
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40 bg-beige-800/95 backdrop-blur-md pt-20">
          <div className="container mx-auto px-6 h-full">
            <ul className="flex flex-col space-y-6 pt-8">
              <li>
                <button 
                  onClick={() => handleNavigation('home')} 
                  className="w-full text-left text-2xl font-semibold text-bordeaux-900 py-4 px-6 bg-gradient-to-r from-beige-300 to-beige-200 rounded-xl hover:from-bordeaux-500 hover:to-bordeaux-600 transition-all duration-300 shadow-lg hover:shadow-bordeaux-400/30 hover:scale-[1.02]"
                >
                  Home
                </button>
              </li>
