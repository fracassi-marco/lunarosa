...
export default function Hero() {
  return (
    ...
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-beige-200/70 via-beige-300/60 to-bordeaux-200/70"></div>
      ...
      <div className="relative z-10 px-4 max-w-5xl mx-auto py-20 pt-32">
        ...
        <div className="space-y-6 text-bordeaux-900">
          ...
          <div className="bg-beige-200/40 backdrop-blur-sm rounded-2xl p-6 md:p-8">
            <h2 className="text-2xl md:text-3xl font-semibold text-bordeaux-700 mb-4">
              Luna Rosa Academy è uno spazio protetto dove puoi:
            </h2>
            <ul className="space-y-3 text-base md:text-lg text-bordeaux-900/95">
        ...
        <div className="text-center mt-10">
          <button
            ...
            className="px-8 py-3 bg-bordeaux-400/80 hover:bg-bordeaux-600 text-white rounded-full transition-all duration-300 hover:scale-105 backdrop-blur-sm text-lg font-medium"
          >
