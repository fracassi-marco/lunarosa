...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-beige-100 to-beige-200 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Logo & Description */}
          <div>
            <h3 className="text-2xl font-bold text-bordeaux-800 mb-4">LUNA ROSA ACADEMY</h3>
            <p className="text-bordeaux-700 leading-relaxed">
            ...
            <ul className="space-y-2">
              <li>
                <button
                  ...
                  className="text-bordeaux-600/80 hover:text-bordeaux-700 transition-colors"
                >
                  Home
                </button>
              </li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-xl font-semibold text-bordeaux-800 mb-4">Contatti</h4>
            <ul className="space-y-2 text-bordeaux-700">
