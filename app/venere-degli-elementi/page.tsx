    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto py-20">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl text-rose-200 mb-8 font-light">
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-purple-950 to-indigo-950">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="bg-gradient-to-br from-purple-900/50 to-indigo-900/50 rounded-2xl p-8 md:p-10 backdrop-blur-sm border border-rose-500/20">
            <p className="text-lg md:text-xl text-rose-100 leading-relaxed mb-6">
          ...
          <div className="bg-gradient-to-br from-purple-900/50 to-indigo-900/50 rounded-2xl p-8 md:p-10 backdrop-blur-sm border border-rose-500/20">
            ...
            <p className="text-base md:text-lg text-rose-100/95 leading-relaxed mb-4">
              Gli incontri si ispirano a pratiche ancestrali, meditazioni, rituali con gli Elementi – 
              <span className="font-semibold text-rose-200"> Terra, Acqua, Aria, Fuoco, Etere</span> – e attività creative 
              come mandala, colori, cristalli ed espressione corporea.
            </p>
            <p className="text-base md:text-lg text-rose-100/95 leading-relaxed">
