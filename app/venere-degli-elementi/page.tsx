...
export default function VenereDegliElementi() {
  return (
    <div className="min-h-screen">
      ...
      {/* Contact Section */}
      <section className="py-20 bg-gradient-to-b from-beige-100 to-beige-100">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-beige-100/50 to-beige-200/50 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <a
                ...
                className="group flex flex-col items-center p-8 bg-gradient-to-br from-bordeaux-500/20 to-bordeaux-600/20 
                         rounded-xl border border-bordeaux-400/30 hover:border-bordeaux-400/60 
